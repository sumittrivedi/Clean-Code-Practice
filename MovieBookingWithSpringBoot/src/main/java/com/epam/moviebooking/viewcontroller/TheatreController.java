...
public class TheatreController {
	...
	public ModelAndView getTheatre(@RequestParam String movieChoice, HttpSession session)
	{
		...
		List<TheatreEntity> theatreList = theatreRestClient.theatreByMovie(locationChoice, movieChoice);		
	...
	public ModelAndView addTheatre(@RequestParam String theatreName,@RequestParam int locationId)
	{
